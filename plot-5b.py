...
ax.set_ylim(0,100)
ax.grid(True)
ax.errorbar(d4b[:,0], d4b[:,3], yerr=d4b[:,4], fmt='bD--', linewidth=0.8,markersize=5.5, markeredgecolor='b', fillstyle='none', capsize=3, label = "w/ tRTis on GKE-4gpu, dyn bat On, avg bat sz = 235")
