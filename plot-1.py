...
ax.errorbar(d1[:,0], d1[:,3], yerr=d1[:,4], fmt='ro--', linewidth=0.8,markersize=4, fillstyle='none', markeredgecolor='r', capsize=3, label = "w/ tRTis on GKE-1gpu")
ax.errorbar(d4[:,0], d4[:,3], yerr=d4[:,4], fmt='bv--', linewidth=0.8,markersize=4, fillstyle='none', markeredgecolor='blue', capsize=3, label = "w/ tRTis on GKE-4gpu")
