...
ax.set_ylim(0,250)
ax.grid(True)
ax.errorbar(d4a[:,0], d4a[:,3], yerr=d4a[:,4]/np.sqrt(d4a[:,0]), fmt='rv--', linewidth=0.8,markersize=7, markeredgecolor='r', fillstyle='none', capsize=3, label = "w/ Triton on GKE-4gpu, dyn bat On, avg bat sz = 235")
ax.errorbar(d4b[:,0], d4b[:,3], yerr=d4b[:,4]/np.sqrt(d4b[:,0]), fmt='bD--', linewidth=0.8,markersize=5.5, markeredgecolor='b', fillstyle='none', capsize=3, label = "w/ Triton on GKE-4gpu, dyn bat Off, avg bat sz = 1700")
...
ax.legend()
fig.tight_layout()
fig.savefig("plot-4_EMTrackMichelID.pdf")
...
ax2.set_ylim(0,350)
ax2.grid(True)
ax2.errorbar(d4a[:,0], d4a[:,1], yerr=d4a[:,2]/np.sqrt(d4a[:,0]), fmt='rv--', linewidth=0.8,markersize=7, markeredgecolor='r', fillstyle='none', capsize=3, label = "w/ Triton on GKE-4gpu, dyn bat On, avg bat sz = 235")
ax2.errorbar(d4b[:,0], d4b[:,1], yerr=d4b[:,2]/np.sqrt(d4b[:,0]), fmt='bD--', linewidth=0.8,markersize=5.5, markeredgecolor='b', fillstyle='none', capsize=3, label = "w/ Triton on GKE-4gpu, dyn bat Off, avg bat sz = 1700")
...
ax2.legend()
fig2.tight_layout()
fig2.savefig("plot-4_FullEvent.pdf")
